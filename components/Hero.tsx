...
const Hero = () => {
  return (
    <div className='pb-12 pt-36'>
      ...
      <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.05] bg-grid-black/[0.8] flex items-center justify-center absolute top-0 left-0">
